...
public class GraficoFrequencias implements Grafico{
    ...
    public GraficoFrequencias(String tituloTabela, String[] titulo, String[][] dados, boolean porcentagem) {
        ...
        String tituloY = porcentagem? "Em porcentagem" : "Em repetições";
        JFreeChart barChart = ChartFactory.createBarChart(
                "Frequencia dos elementos de: \""+tituloTabela+"\"", tituloTabela, tituloY, criarDados(titulo, dados), PlotOrientation.VERTICAL,
                false, true, false);
